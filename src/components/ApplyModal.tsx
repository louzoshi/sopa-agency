...
export default function ApplyModal({ locale, onClose }: { locale: string; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 pt-24" onClick={onClose}>
      ...
      <div
        className="relative w-full max-w-md overflow-y-auto rounded-2xl border border-white/15 bg-black/90 p-8 shadow-[0_0_60px_rgba(var(--accent-rgb),0.08)] backdrop-blur-xl"
